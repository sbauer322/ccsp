defmodule CCSP.Chapter4.MST do
  ...
  @spec visit(WeightedGraph.t, list(boolean), PriorityQueue.t, non_neg_integer) :: {list(boolean), PriorityQueue.t}
  defp visit(wg, visited, pq, index) do
    visited = List.update_at(visited, index, fn _ -> true end)
    pq = WeightedGraph.edges_for_index(wg, index)
